...
export const metadata: Metadata = {
  title: "Nhịp hồi phục | Retour",
  description:
    "Retour là chương trình 6 buổi theo nhịp của SOFT Framework, thư viện thực hành và các hướng dẫn nhẹ nhàng giúp người làm việc trí óc ngủ sâu hơn, giảm căng thẳng và tái tạo năng lượng."
};

export default function RecoveryRhythmPage() {
  return (
    <>
